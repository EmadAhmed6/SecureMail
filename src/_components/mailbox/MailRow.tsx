...
export const MailRow = React.memo(
  ({
    ...
    const getPhishingLevel = (email: Email) => {
      if (email.phishingScore >= 80) return "critical";
      if (email.phishingScore >= 60) return "high";
      if (email.phishingScore >= 30) return "medium";
      return "safe";
    };
    ...
    const phishingLevel = getPhishingLevel(email);
